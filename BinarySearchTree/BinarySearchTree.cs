...
public class BinarySearchTree<T> where T : IComparable<T>
{
    ...
    public BinarySearchTree<T> ToBalancedBSTree2(List<T> list)
    {
        return ToBalancedBSTree2(list, 0, list.Count - 1);
    }

    private BinarySearchTree<T> ToBalancedBSTree2(List<T> list, int lIndex, int rIndex, BinarySearchTree<T> bst = null)
    {
...
public class BinarySearchTree
{
    public static void Main(String[] args)
    {
        ...
        while (true)
        {
            ...
            BinarySearchTree<int> tree1Copy = new BinarySearchTree<int>();
            ...
            while (num != 0)
            {
                ...
                Console.WriteLine("Removing Node with Value 16 from AVL Tree... (Recursion)");
            ...
            //BinarySearchTree<int> tree2Copy = new BinarySearchTree<int>();
            ...
            Console.WriteLine("Balanced BSTree:  Top-Down Balance after tree has been fully generated");
            ...
            Console.WriteLine("AVL Tree:  Bottom-Up Balance each time a new Node is added");
            ...
            Console.WriteLine("Converting BSTree to a Sorted List (Dynamic Array)... (Recursion)");
            ...
            Console.WriteLine("Converting List to a Balanced BSTree... (Recursion)");
            BinarySearchTree<int> tree3 = tree1Copy.ToBalancedBSTree2(list);
            Console.WriteLine();
            ...
            (BinarySearchTree<int>.Node, BinarySearchTree<int>.Node) llNodes = tree1Copy.ToSinglyLinkedList();
            Console.WriteLine();

            BinarySearchTree<int>.Node head1 = llNodes.Item1;
            BinarySearchTree<int>.Node tail1 = llNodes.Item2;

            BinarySearchTree<int>.Node head1Copy = head1;
            ...
            Console.WriteLine("Creating a Sorted Doubly-Linked List from the Original BSTree (\"Flattened Tree\")... (Recursion)");
            (BinarySearchTree<int>.Node, BinarySearchTree<int>.Node) dllNodes = tree1Copy.ToDoublyLinkedList();
            Console.WriteLine();

            BinarySearchTree<int>.Node head2 = dllNodes.Item1;
            BinarySearchTree<int>.Node tail2 = dllNodes.Item2;

            BinarySearchTree<int>.Node head2Copy = head2;
            BinarySearchTree<int>.Node tail2Copy = tail2;
            ...
            (BinarySearchTree<int>.Node, BinarySearchTree<int>.Node) cllNodes = tree1Copy.ToCircularSinglyLinkedList();
            Console.WriteLine();

            BinarySearchTree<int>.Node head3 = cllNodes.Item1;
            BinarySearchTree<int>.Node tail3 = cllNodes.Item2;
            ...
            (BinarySearchTree<int>.Node, BinarySearchTree<int>.Node) cdllNodes = tree1Copy.ToCircularDoublyLinkedList();
            Console.WriteLine();

            BinarySearchTree<int>.Node head4 = cdllNodes.Item1;
            BinarySearchTree<int>.Node tail4 = cdllNodes.Item2;

            BinarySearchTree<int>.Node head4Copy = head4;
            BinarySearchTree<int>.Node tail4Copy = tail4;
